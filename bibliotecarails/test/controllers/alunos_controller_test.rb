...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { cpf: @aluno.cpf, datanascimento: @aluno.datanascimento, endereco: @aluno.endereco, matricula: @aluno.matricula, nome: @aluno.nome } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { cpf: @aluno.cpf, datanascimento: @aluno.datanascimento, endereco: @aluno.endereco, matricula: @aluno.matricula, nome: @aluno.nome } }
